...
function OAuthReauthForm({
  ...
  const onCancel = (): void => {
    ...
    cancelLoginMutate({ providerId, mcpAuth: null, profileId: null });
    setAwaiting(false);
  };
  ...
  const onAuthenticate = (): void => {
    ...
    startLogin.mutate(
      ...
      { providerId, mcpAuth: null, profileId: null, createProfile: null },
      {
        onSuccess: (data) => {
          ...
          awaitLoginMutate(
            { providerId, mcpAuth: null, profileId: null },
